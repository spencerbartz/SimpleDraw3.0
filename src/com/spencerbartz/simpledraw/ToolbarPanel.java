...
//implements ActionListener, ItemListener, ChangeListener
{
    ...
    public ImageIcon rectangleIcon;
    public ImageIcon ovalIcon;
    public ImageIcon lineIcon;
    public ImageIcon pencilIcon;
    public ImageIcon paintbucketIcon;
    public ImageIcon paintbucketCursor;
    
    private JLabel rectLabel;
    private JLabel ovalLabel;
    private JLabel lineLabel;
    private JLabel pencilLabel;
    private JLabel paintbucketLabel;
    ...
    private JRadioButton paintbucket;
    
    private JCheckBox fillCheckBox;
    
    private BufferedImage currColorDisp;
    private BufferedImage fillColorDisp;
    ...
    private JButton currColorButton;
